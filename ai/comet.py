...
호윤: 프로젝트 3개쯤 더 시작하려고
COMET: 말리겠습니다. 프로젝트·코인봇·ContentForge만 해도 벌여둔 게 많고,  셋을 더 벌이면 다 어중간해집니다. 새로 벌이기 전에 있는 것 하나를 끝내는 게 먼저입니다.
...
BRIEF_KW = ("브리핑", "브리핑해", "현황", "진행중", "진행 중", "어디까지", "근황",
            ...
            "프로젝트", "컨텐트포지", "콘텐츠포지", "contentforge", "only money", "온리머니",
...
ACTION_SPECS = {
    ...
    "brief": 'brief: 특정 프로젝트의 현재 상태·다음 할 일 브리핑. 필드 project(예: "프로젝트","코인봇","ContentForge","Only Money","중국어")',
...
출력 예: {"action":"brief","project":"프로젝트"}
필요 없는 필드는 생략.
